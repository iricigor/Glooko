@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'v1.2: Added CGM analysis functions (Get-GlookoCGMStats and Get-GlookoCGMStatsExtended) for analyzing glucose data with in-range statistics. See CHANGELOG.md for detailed release notes: https://github.com/iricigor/Glooko/blob/main/CHANGELOG.md'
        }
    }
