function Get-GlookoCGMStatsExtended {
    ...
    .DESCRIPTION
        ...
        with customizable ranges including very low, low, in range, high, and very high categories.
    ...
    .PARAMETER VeryLowThreshold
        Threshold for very low readings in mmol/L. Default is 3.0.
    ...
    .PARAMETER LowThreshold
        ...
        Readings between VeryLowThreshold and LowThreshold are considered low.
    ...
    .PARAMETER VeryHighThreshold
        Threshold for very high readings in mmol/L. Default is 14.0.
